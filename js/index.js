...
angular.module("novilhomsBiMobile", [])
...
angular.module("novilhomsBiMobile").controller("novilhomsBiMobileCtrl", function($scope, $http) {
    $scope.app = "novilhomsBiMobile";
    ...
    var d = new Date();
    $scope.footerYear = d.getFullYear();
